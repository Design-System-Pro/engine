...
const AUTH_API_HOST = 'http://localhost:3000';
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const refreshAccessToken = useCallback(async () => {
    ...
    const response = await fetch(`${AUTH_API_HOST}/api/auth/refresh`, {
      method: 'POST',
